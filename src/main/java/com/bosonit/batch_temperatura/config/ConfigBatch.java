...
import com.bosonit.batch_temperatura.job.step3.RowMapperStep3;
import com.bosonit.batch_temperatura.job.step3.WeaterRiskItemWriteStep3;
import com.bosonit.batch_temperatura.job.step3.WeaterItemProcessorStep3;
...
public class ConfigBatch {
    ...
    public Step step3(){
        return stepBuilderFactory.get("step3")
                ...
                .processor(new WeaterItemProcessorStep3())
                .writer(weaterRiskItemWriteStep3())
                .build();
    }
    @Bean
    public Step step4(){
